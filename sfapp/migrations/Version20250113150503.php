 ...
 */
final class Version20250113150503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE detail_intervention (id INT AUTO_INCREMENT NOT NULL, technicien_id INT NOT NULL, salle_id INT NOT NULL, date_ajout DATE NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_CD1B7EA413457256 (technicien_id), INDEX IDX_CD1B7EA4DC304035 (salle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE detail_plan (id INT AUTO_INCREMENT NOT NULL, salle_id INT DEFAULT NULL, plan_id INT DEFAULT NULL, sa_id INT DEFAULT NULL, date_ajout DATETIME NOT NULL, etat_sa VARCHAR(255) DEFAULT NULL, date_enleve DATETIME DEFAULT NULL, INDEX IDX_2A0FB3F2DC304035 (salle_id), INDEX IDX_2A0FB3F2E899029B (plan_id), UNIQUE INDEX UNIQ_2A0FB3F262CAE146 (sa_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
