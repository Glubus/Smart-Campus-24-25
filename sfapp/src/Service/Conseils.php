...
class Conseils
{
    ...
    public function getConseilsGeneraux(ApiWrapper $wrapper, float $tempInt, float $co2Int, float $humiInt){
        ...
        return $conseilsImportants;
    }

    public function getConseilsParCapteur(ApiWrapper $wrapper, float $tempInt, float $co2Int, float $humiInt){
        ...
        if($tempInt < $tempExt-2){
            ...
            $conseilTemp .= "Limitez les ouvertures de fenêtres pour préserver la chaleur intérieure. ";
        }
